...
var file_order_service_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0a, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x57, 0x61,
	0x79, 0x22, 0x46, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x74, 0x69, 0x6d, 0x65, 0x53, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x69, 0x0a, 0x0d, 0x4f, 0x72, 0x64,
	...
	0x61, 0x74, 0x75, 0x73, 0x32, 0x57, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x47, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x49, 0x6e, 0x66, 0x6f, 0x12, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x57, 0x61,
	0x79, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x57, 0x61, 0x79, 0x2e, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x62, 0x06, 0x70,
...
var file_order_service_proto_goTypes = []interface{}{
	(*OrderRequest)(nil),  // 0: serviceWay.OrderRequest
	(*OrderResponse)(nil), // 1: serviceWay.OrderResponse
}
var file_order_service_proto_depIdxs = []int32{
	0, // 0: serviceWay.OrderService.GetOrderInfo:input_type -> serviceWay.OrderRequest
	1, // 1: serviceWay.OrderService.GetOrderInfo:output_type -> serviceWay.OrderResponse
...
type OrderServiceClient interface {
	GetOrderInfo(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (OrderService_GetOrderInfoClient, error)
}
...
func (c *orderServiceClient) GetOrderInfo(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (OrderService_GetOrderInfoClient, error) {
	stream, err := c.cc.NewStream(ctx, &_OrderService_serviceDesc.Streams[0], "/serviceWay.OrderService/GetOrderInfo", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *orderServiceGetOrderInfoClient) Recv() (*OrderResponse, error) {
	m := new(OrderResponse)
...
func (x *orderServiceGetOrderInfoServer) Send(m *OrderResponse) error {
	return x.ServerStream.SendMsg(m)
}

var _OrderService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "serviceWay.OrderService",
